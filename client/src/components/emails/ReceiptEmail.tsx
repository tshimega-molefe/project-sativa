...
export const ReceiptEmail = ({
  ...
  const total = products.reduce((acc, curr) => acc + curr.price, 0) + 2 + 2;

  return (
    <Html>
      <Head />
      <Preview>Your Sativa Receipt</Preview>
      ...
      <Body style={main}>
        <Container style={container}>
          <Section>
            <Column>
              <Img
                src={`${process.env.NEXT_PUBLIC_SERVER_URL}/sativa-email-sent.png`}
                width="100"
                height="100"
                alt="Sativa"
              />
          ...
          <Section>
            ...
            <Column style={productPriceWrapper} align="right">
              <Text style={productPrice}>{formatPrice(2)}</Text>
            </Column>
          </Section>
