...
function constructMetadata(_a) {
    ...
    return __assign({ title: title, description: description, openGraph: {
            ...
            images: [image],
            creator: "@sativa-inc",
        }, icons: icons, metadataBase: new URL("http://sativa.up.railway.app") }, (noIndex && {
        robots: {
            index: false,
            follow: false,
        },
