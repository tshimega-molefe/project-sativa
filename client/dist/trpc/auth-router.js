...
var sign_up_schema_1 = require("../lib/validators/sign-up-schema");
var trpc_1 = require("./trpc");
var get_payload_1 = require("../get-payload");
var server_1 = require("@trpc/server");
var zod_1 = require("zod");
var sign_in_schema_1 = require("../lib/validators/sign-in-schema");
exports.authRouter = (0, trpc_1.router)({
    createPayloadUser: trpc_1.publicProcedure
        .input(sign_up_schema_1.SignUpFormSchema)
    ...
    signIn: trpc_1.publicProcedure
        .input(sign_in_schema_1.SignInFormSchema)
        .mutation(function (_a) {
