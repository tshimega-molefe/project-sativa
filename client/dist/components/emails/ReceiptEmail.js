...
var ReceiptEmail = function (_a) {
    ...
    var total = products.reduce(function (acc, curr) { return acc + curr.price; }, 0) + 2;
    return (React.createElement(components_1.Html, null,
        React.createElement(components_1.Head, null),
        React.createElement(components_1.Preview, null, "Your Sativa Receipt"),
        React.createElement(components_1.Body, { style: main },
            React.createElement(components_1.Container, { style: container },
                React.createElement(components_1.Section, null,
                    React.createElement(components_1.Column, null,
                        React.createElement(components_1.Img, { src: "".concat(process.env.NEXT_PUBLIC_SERVER_URL, "/sativa-email-sent.png"), width: "100", height: "100", alt: "Sativa" })),
                ...
                React.createElement(components_1.Section, null,
                    ...
                    React.createElement(components_1.Column, { style: productPriceWrapper, align: "right" },
                        React.createElement(components_1.Text, { style: productPrice }, (0, utils_1.formatPrice)(2)))),
                React.createElement(components_1.Section, null,
                    React.createElement(components_1.Column, { style: { width: "64px" } }),
                    React.createElement(components_1.Column, { style: {
                            paddingLeft: "40px",
                        ...
                        React.createElement(components_1.Text, { style: productTitle }, "Delivery Cost")),
                    React.createElement(components_1.Column, { style: productPriceWrapper, align: "right" },
                        React.createElement(components_1.Text, { style: productPrice }, (0, utils_1.formatPrice)(2)))),
