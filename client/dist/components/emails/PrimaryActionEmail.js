...
var EmailTemplate = function (_a) {
    ...
    return (React.createElement(components_1.Html, null,
        ...
        React.createElement(components_1.Preview, null, "The marketplace for high-quality Cannabis, Hemp, and CBD goods."),
        React.createElement(components_1.Body, { style: main },
            React.createElement(components_1.Container, { style: container },
                React.createElement(components_1.Img, { src: "".concat(process.env.NEXT_PUBLIC_SERVER_URL, "/sativa-welcome-image.png"), width: "150", height: "150", alt: "Sativa", style: logo }),
                React.createElement(components_1.Text, { style: paragraph }, "Hi there,"),
                React.createElement(components_1.Text, { style: paragraph },
                    "Welcome to Sativa, the marketplace for high quality Cannabis, Hemp, and CBD goods. Use the button below to ",
                    actionLabel,
                    "."),
